...
exports.up = (pgm) => {
  pgm.sql("INSERT INTO users (id, username, password, fullname) VALUES('old-owner', 'old-owner', 'old-owner', 'old-owner')");

  // mengubah nilai owner pada note yang owner-nya bernilai NULL
  pgm.sql("UPDATE notes SET owner = 'old-owner' WHERE owner = NULL");
